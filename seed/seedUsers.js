...
// config/allowedUsers.js). The app has no signup UI, so this is the only way
// accounts get created. Each account's password is set explicitly in
// allowedUsers.js and stored bcrypt-hashed here. Any User document whose
